...
(function() {
    ...
    function r(e, r) {
        ...
        for (var s = 0; s < e.length; ++s) {
            ...
            if (i.filter) {
                ...
                if (a.helper.isString(i.regex) && (i.regex = new RegExp(i.regex,"g")),
        ...
        this.makeMarkdown = this.makeMd = function(e, r) {
            function t(e) {
                for (var r = 0; r < e.childNodes.length; ++r) {
                    ...
                    a.nodeValue = a.nodeValue.replace(/(\s)+/g, "$1")) : (e.removeChild(a),
                    --r) : 1 === a.nodeType && t(a)
                }
            }
            if (e = e.replace(/\r\n/g, "\n"),
    ...
    a.subParser("anchors", function(e, r, t) {
        ...
        var n = function(e, n, s, o, i, l, c) {
            ...
            r.openLinksInNewWindow && !/^#/.test(o) && (u += ' target="¨E95Eblank"'),
            u += ">" + n + "</a>"
        };
        ...
        e = e.replace(/\[([^\[\]]+)]()()()()()/g, n),
        r.ghMentions && (e = e.replace(/(^|\s)(\\)?(@([a-z\d]+(?:[a-z\d.-]+?[a-z\d]+)*))/gim, function(e, t, n, s, o) {
            if ("\\" === n)
                return t + s;
            ...
            var i = r.ghMentionsLink.replace(/\{u}/g, o)
              , l = "";
            return r.openLinksInNewWindow && (l = ' target="¨E95Eblank"'),
            t + '<a href="' + i + '"' + l + ">" + s + "</a>"
        })),
    ...
    var u = /([*~_]+|\b)(((https?|ftp|dict):\/\/|www\.)[^'">\s]+?\.[^'">\s]+?)()(\1)?(?=\s|$)(?!["<>])/gi
      ...
      , m = function(e, r) {
        ...
        return function(t, n, s) {
            ...
            e.encodeEmails ? (o = a.helper.encodeEmailAddress(o + s),
            s = a.helper.encodeEmailAddress(s)) : o += s,
            n + '<a href="' + o + '">' + s + "</a>"
        }
    };
    ...
    a.subParser("unhashHTMLSpans", function(e, r, t) {
        ...
        for (var a = 0; a < t.gHtmlSpans.length; ++a) {
            for (var n = t.gHtmlSpans[a], s = 0; /¨C(\d+)C/.test(n); ) {
                var o = RegExp.$1;
                if (n = n.replace("¨C" + o + "C", t.gHtmlSpans[o]),
                10 === s) {
    ...
    a.subParser("images", function(e, r, t) {
        ...
        function n(e, r, n, s, o, i, l, c) {
            ...
            e.search(/\(<?\s*>? ?(['"].*['"])?\)$/m) > -1)
                ...
                a.helper.isUndefined(p[n]) || (o = p[n].width,
                i = p[n].height)
            }
        ...
        function n(e, n) {
            ...
            e = e.replace(s, function(e, n, s, i, l, c, u) {
                ...
                var d = a.subParser("outdent")(l, r, t)
                  , p = "";
                return c && r.tasklists && (p = ' class="task-list-item" style="list-style-type: none;"',
                ...
                n || d.search(/\n{2,}/) > -1 ? (d = a.subParser("githubCodeBlocks")(d, r, t),
                d = a.subParser("blockGamut")(d, r, t)) : (d = (d = a.subParser("lists")(d, r, t)).replace(/\n$/, ""),
    ...
    a.subParser("metadata", function(e, r, t) {
        ...
        return r.metadata ? (e = t.converter._dispatch("metadata.before", e, r, t),
        e = e.replace(/^\s*«««+(\S*?)\n([\s\S]+?)\n»»»+\n/, function(e, r, t) {
            return a(t),
            "¨M"
        }),
        ...
        e = e.replace(/¨M/g, ""),
        e = t.converter._dispatch("metadata.after", e, r, t)) : e
    }),
    ...
    a.subParser("paragraphs", function(e, r, t) {
        ...
        for (var n = (e = (e = (e = t.converter._dispatch("paragraphs.before", e, r, t)).replace(/^\n+/g, "")).replace(/\n+$/g, "")).split(/\n{2,}/g), s = [], o = n.length, i = 0; i < o; i++) {
            var l = n[i];
            l.search(/¨(K|G)(\d+)\1/g) >= 0 ? s.push(l) : l.search(/\S/) >= 0 && (l = (l = a.subParser("spanGamut")(l, r, t)).replace(/^([ \t]*)/g, "<p>"),
            l += "</p>",
            s.push(l))
        }
        for (o = s.length,
    ...
    a.subParser("stripLinkDefinitions", function(e, r, t) {
        ...
        var n = function(e, n, s, o, i, l, c) {
            ...
            l ? l + c : (c && (t.gTitles[n] = c.replace(/"|'/g, "&quot;")),
            r.parseImgDimensions && o && i && (t.gDimensions[n] = {
                width: o,
                height: i
            }),
            "")
    ...
    a.subParser("underline", function(e, r, t) {
        ...
        e = r.literalMidWordUnderscores ? (e = e.replace(/\b___(\S[\s\S]*?)___\b/g, function(e, r) {
            return "<u>" + r + "</u>"
        })).replace(/\b__(\S[\s\S]*?)__\b/g, function(e, r) {
            return "<u>" + r + "</u>"
        ...
        e = e.replace(/(_)/g, a.helper.escapeCharactersCallback),
        e = t.converter._dispatch("underline.after", e, r, t)) : e
    }),
    ...
    a.subParser("makeMarkdown.image", function(e) {
        "use strict";
        var r = "";
        return e.hasAttribute("src") && (r += "![" + e.getAttribute("alt") + "](",
